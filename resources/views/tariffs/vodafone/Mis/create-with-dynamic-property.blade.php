                                                ...
                                                <div class="form-group m-form__group">
                                                    @foreach($properties->unique('category') as $category)
                                                        ...
                                                        @foreach($properties as $property)
                                                            ...
                                                            @endif
                                                        @endforeach
                                                        <!-- begin - New property, if necessary -->
                                                        @if($category->category == "Tarifvorteile")
                                                            <div class="form-group m-form__group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">{{__('tariffs\vodafone\create.newProperty')}}</label>
                                                                <div class="col-xl-1 col-lg-1">
                                                                    <span class="m-switch m-switch--sm m-switch--icon">
                                                                        <label>
                                                                            <input type="checkbox"  name="newPropertyCheckbox" id="newPropertyCheckbox">
                                                                            <span></span>
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                                <div class="col-xl-3 col-lg-3" id="newPropertyAttributeDIV">
                                                                    <input type="text" name="newPropertyAttribute" id="newPropertyAttribute" class="form-control m-input"  aria-describedby="basic-addon1" placeholder="{{__('tariffs\vodafone\create.newPropertyAttribute')}}">
                                                                </div>
                                                                <div class="col-xl-3 col-lg-3" id="newPropertyValueDIV">
                                                                    <input type="text" name="newPropertyValue" id="newPropertyValue" class="form-control m-input"  aria-describedby="basic-addon1" placeholder="{{__('tariffs\vodafone\create.newPropertyValue')}}">
                                                                </div>
                                                            </div>
                                                        @endif
                                                        <!-- end - New property, if necessary -->
                                                        <div class="m-separator m-separator--dashed m-separator--lg"></div>
                                                    @endforeach
                                                </div>
                                            </div>
...
@section('pageVendorsAndScripts')
    ...
    <script src="{{ asset('js/tariffVodafoneCreate1.js')}}" type="text/javascript"></script>
