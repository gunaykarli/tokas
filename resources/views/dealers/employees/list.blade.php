    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">{{__('dealers\employees\list.employees')}}</h3>
            ...
            <div class="m-portlet m-portlet--mobile">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                {{__('dealers\employees\list.employeeList')}}
                            </h3>
                        </div>
                    </div>
                        ...
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                @can('create', \App\User::class)
                                    <a href="/employee/create/{{$dealerID}}" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air">
                                                    <span>
                                                        <i class="la la-plus"></i>
                                                        <span>{{__('dealers\employees\list.newEmployee')}}</span>
                                                    </span>
                                    </a>
                                @endcan
                            </li>
                ...
                <div class="m-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                        <thead>
                        <tr>
                            <th>{{__('dealers\employees\list.employeeID')}}</th>
                                        ...
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                 @can('update', \App\User::class)
                                                     <a class="dropdown-item" href="/employee/edit/{{$employee->id}}"><i class="la la-edit"></i>{{__('dealers\employees\list.update')}}</a>
                                                 @endcan
                                            </div>
                                        </span>
                                        @can('update', \App\User::class)
                                            <a  href="/employee/edit/{{$employee->id}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="{{__('dealers\employees\list.update')}}">
