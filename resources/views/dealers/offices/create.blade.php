        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <h1> {{__('dealers/offices/list.offices')}} - {{$dealer->name}}</h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="/office/list/{{$dealer->id}}">{{__('dealers/offices/create.offices')}}</a></li>
                    </ol>
                </div><!-- /column -->
            </div><!-- /row -->
        </div><!-- /container -->
...
@section ('content')
    <!--begin: Form -->
    <form method="POST" action="/office/store" class="form-horizontal" role="form">
    @csrf

    <input type="hidden" name="dealerID" value={{$dealer->id}}> <!--$dealerID is sent from OfficeController@store -->
        ...
        <section class="pt30 mb20">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="lead text-center flipInY-animated">{{__('dealers/offices/create.newOffice')}}</p>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="officeName" class="form-control" placeholder="" value="">
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        @if (auth()->check())
                            <select name="contactPersonID" class="form-control">
                                <option >{{__('dealers/offices/create.selectPerson')}}</option>
        ...
        <section class=" mb20">
            <div class="container">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="streetAddress" class="form-control" placeholder="" value="" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 control-label">{{__('dealers/offices/create.POBox')}}</label>
                    <div class="col-md-4">
                        <input type="text" name="POBox" class="form-control" placeholder="" value="">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 control-label">{{__('dealers/offices/create.postalCode')}}</label>
                    <div class="col-md-4">
                        <input type="text" name="postalCode" class="form-control" placeholder="" value="">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="state" class="form-control" placeholder="" value="">
                    </div>
                </div>
                <div class="form-group row">
