            ...
            <div class="m-portlet m-portlet--full-height">
                ...
                <div class="m-wizard m-wizard--2 m-wizard--success" id="m_wizard">
                    ...
                    <div class="m-wizard__form">
                        ...
                        <!--begin: Form -->
                        <form method="POST" action="/office/update/{{$office->id}}" class="m-form m-form--label-align-left- m-form--state-" id="m_form">
                            @csrf
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Office Details</h3>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* Office Type:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="officeName" class="form-control m-input" placeholder="" value={{$office->name}}>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        @if (auth()->check())
                                                            <select name="contactPersonID" class="form-control m-input">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="phone" class="form-control m-input" placeholder="" value={{$office->phone}}>
                                                    </div>
                                                </div>
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Office Address</h3>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* Address Line :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="streetAddress" class="form-control m-input" placeholder="" value={{$office->address->street_address}} >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">P.O. box:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="POBox" class="form-control m-input" placeholder="" value={{$office->address->PO_box}}>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Postal Code:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="postalCode" class="form-control m-input" placeholder="" value={{$office->address->postal_code}}>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* City:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="city" class="form-control m-input" placeholder="" value={{$office->address->city}}>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* State:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="state" class="form-control m-input" placeholder="" value={{$office->address->state}}>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            ...
                                            <ul class="nav nav-tabs m-tabs-line--2x m-tabs-line m-tabs-line--danger" role="tablist">
                                                <li class="nav-item m-tabs__item">
                                                    <a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_form_confirm_1" role="tab">1. Suboffice Info</a>
                                                </li>
                                                <li class="nav-item m-tabs__item">
                                                    <a class="nav-link m-tabs__link" data-toggle="tab" href="#m_form_confirm_2" role="tab">2. Suboffice Address</a>
                                                </li>
                                            </ul>
