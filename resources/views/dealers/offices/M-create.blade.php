            ...
            <div class="m-portlet m-portlet--full-height">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                Suboffice
                                <small>Suboffice Registration</small>
                            </h3>
                        </div>
                    </div>
                ...
                <div class="m-wizard m-wizard--2 m-wizard--success" id="m_wizard">
                    ...
                    <div class="m-wizard__form">
                        ...
                        <!--begin: Form -->
                        <form method="POST" action="/office/store" class="m-form m-form--label-align-left- m-form--state-" id="m_form">
                            @csrf

                            <input type="hidden" name="dealerID" value={{$dealer->id}}> <!--$dealerID is sent from OfficeController@create -->
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Suboffice Details</h3>
                                                </div>
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        @if (auth()->check())
                                                            <select name="contactPersonID" class="form-control m-input"  >
                                                                ...
                                                                @foreach($dealer->user as $employee)
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Subffice Address</h3>
                                                </div>
                                                <div class="form-group m-form__group row">
