    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Dealer Management</h3>
            ...
            <div class="m-portlet m-portlet--full-height">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                Dealer Registration
                                <small>Dealer Registration</small>
                            </h3>
                        </div>
                    </div>
                ...
                <div class="m-wizard m-wizard--2 m-wizard--success" id="m_wizard">
                    ...
                    <div class="m-wizard__form">
                        ...
                        <!--begin: Form -->
                        <form method="POST" action="/dealer/store" class="m-form m-form--label-align-left- m-form--state-" id="m_form">
                            @csrf
                            <!--begin: Form Body -->
                            <div class="m-portlet__body">
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Dealer Details</h3>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* Dealer Name:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="name" class="form-control m-input" placeholder="" value="Günter">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="ownerName" class="form-control m-input" placeholder="" value="Günter">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="ownerSurname" class="form-control m-input" placeholder="" value="Günter">
                                                    </div>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* Owner Mobile:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="ownerMobile" class="form-control m-input" placeholder="" value="555 1390">
                                                    </div>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label" for="exampleInputEmail1">* Owner Email</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text">@</span></div>
                                                            <input type="email" name="ownerEmail" class="form-control m-input" placeholder="Email" aria-describedby="basic-addon1" value="g@g.com">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Main Office Details</h3>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* Office Name:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="officeName" class="form-control m-input" placeholder="" value="Sancak">
                                                    </div>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Office Phone:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="phone" class="form-control m-input" placeholder="" value="555">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="streetAddress" class="form-control m-input" placeholder="" value="123" >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">P.O. box:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="POBox" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Postal Code:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="postalCode" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* City:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="city" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* State:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="state" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="vodafoneUVP" class="form-control m-input" placeholder="" value="123" >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Vodafone GVO :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="vodafoneGVO" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Vodafone DSL UVP :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="vodafoneDSLUVP" class="form-control m-input" placeholder="" value="123" >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Mobilcom Debitel UVP :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="mobilcomDebitelUVP" class="form-control m-input" placeholder="" value="123" >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Energie User :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="energieUser" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Yourfone UVP :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="yourfoneUVP" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Ay Yıldız UVP :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="ayyildizUVP" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Blau UVP :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="blauUVP" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Otelo Neu :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="oteloNeu" class="form-control m-input" placeholder="" value="123" >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Otelo Alt :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="oteloAlt" class="form-control m-input" placeholder="" value="123" >
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="IBAN" class="form-control m-input" placeholder="DE6666"  >
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_5">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Admin Account</h3>
                                                </div>


                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Contact Person Info</label>
                                                        <div class="col-xl-9 col-lg-9">
                                                            <label class="m-checkbox m-checkbox--state-primary">
                                                                <input type="checkbox"> Transfer from the owner info
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="accountName" class="form-control m-input" placeholder="" value="A">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="accountSurname" class="form-control m-input" placeholder="" value="B">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="accountMobile" class="form-control m-input" placeholder="" value="1-541-754-3010">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text">@</span></div>
                                                            <input type="email" name="accountEmail" class="form-control m-input" placeholder="Email" aria-describedby="basic-addon1" value="...@gmail.com">
                                                        </div>
                                ...
                                <!--begin: Form Wizard Step 6 Confirmation-->
