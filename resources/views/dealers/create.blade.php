...
@section ('content')
    <!--begin: Form -->
    <form method="POST" action="/dealer/store" class="form-horizontal" role="form">
    @csrf
        <!--begin: Form Body -->
        ...
        <section class="pt30 mb20">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="lead text-center flipInY-animated"> {{__('dealers\create.newDealer')}} </p>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="checkbox" name="status" checked data-toggle="toggle" data-onstyle="primary" data-size="mini">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="checkbox" name="limitedSales" id="limitedSales" checked data-toggle="toggle" data-onstyle="primary" data-size="mini" data-on="Ja" data-off="Nein">
                    </div>
                </div>
                ...
                <div class="form-group row" id="salesLimitDIV">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="salesLimit" class="form-control m-input" placeholder="">
                    </div>
                </div>
        ...
        <section class=" mb20">
            <div class="container">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="officeName" class="form-control input-group">
                    </div>
                </div>
                 <div class="form-group row">
        ...
        <section class=" mb20">
            <div class="container">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="IBAN" class="form-control m-input">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 text-right">{{__('dealers\create.cashDeposit')}}:</label>
                    <div class="col-md-4">
                        <input type="checkbox" name="cashDeposit" checked data-toggle="toggle" data-onstyle="primary" data-size="mini" data-on="Ja" data-off="Nein">
                    </div>
                </div>
        ...
        <section class=" mb20">
            <div class="container">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="userName" class="form-control m-input" placeholder="" value="B">
                    </div>
                </div>
                <div class="form-group row">
