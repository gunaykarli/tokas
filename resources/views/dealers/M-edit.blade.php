                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-group">
                                                            ...
                                                            <input type="email" name="ownerEmail" class="form-control m-input" placeholder="Email" aria-describedby="basic-addon1" value={{$dealer->owner_email}} owner_email>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <span class="m-switch m-switch--sm m-switch--icon">
                                                            <label>
                                                                <input type="checkbox"  @if($dealer->status == 'on') {{'checked="checked"'}} @endif name="status">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="officeName" class="form-control m-input" placeholder="" value={{$mainOffice->name}}>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <span class="m-switch m-switch--sm m-switch--icon">
                                                            <label>
                                                                <input type="checkbox" @if ($bankAccount->cash_deposit == 'on') {{'checked="checked"'}} @endif name="cashDeposit">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <span class="m-switch m-switch--sm m-switch--icon">
                                                            <label>
                                                                <input type="checkbox"
                                                                       @if ($adminAccount->status == 'on') {{'checked="checked"'}} @endif
                                                                       name="status">
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text">@</span></div>
                                                            <input type="email" name="accountEmail" class="form-control m-input" placeholder="Email" aria-describedby="basic-addon1" value={{$adminAccount->email}}>
                                                        </div>
