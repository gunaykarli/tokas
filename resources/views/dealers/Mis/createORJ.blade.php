    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Form Wizard 2</h3>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-group">
                                                            ...
                                                            <input type="email" name="e_mail" class="form-control m-input" placeholder="Email" aria-describedby="basic-addon1" value="g@g.com">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Mailing Address Details</h3>
                                                </div>
                                                <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="IBAN" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="accountName" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Surname :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="accountSurname" class="form-control m-input" placeholder="" value="123">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <div class="input-group m-input-group">
                                                            <input type="password" name="password" class="form-control m-input" placeholder="" value="Tokas.123" disabled >
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            ...
                                            <ul class="nav nav-tabs m-tabs-line--2x m-tabs-line m-tabs-line--danger" role="tablist">
                                                ...
                                                <li class="nav-item m-tabs__item">
                                                    <a class="nav-link m-tabs__link" data-toggle="tab" href="#m_form_confirm_4" role="tab">3. Billing Setup</a>
                                                </li>
                                                <li class="nav-item m-tabs__item">
                                                    <a class="nav-link m-tabs__link" data-toggle="tab" href="#m_form_confirm_5" role="tab">3. Billing Setup</a>
                                                </li>
                                            </ul>
