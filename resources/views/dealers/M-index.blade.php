    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">{{__('dealers\list.dealers')}}</h3>
                                    ...
                                    <td>
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item"  href="/dealer/view/{{$dealer->id}}" ><i class="la la-cc-discover"></i>{{__('dealers\list.view')}}</a>
                                                @can('update', $dealer)
                                                    <a class="dropdown-item" href="/dealer/edit/{{$dealer->id}}"><i class="la la-edit"></i>{{__('dealers\list.update')}}</a>
                                                @endcan
                                                @can('list', \App\Office::class)
                                                    <a class="dropdown-item" href="/office/list/{{$dealer->id}}"><i class="la la-building"></i>{{__('dealers\list.offices')}}</a>
                                                @endcan
                                                @can('list', \App\User::class)
                                                    <a class="dropdown-item" href="/employee/list/{{$dealer->id}}"><i class="la la-user"></i>{{__('dealers\list.employees')}}</a>
                                                @endcan

                                            </div>
                                        </span>
                                        <a href="/dealer/view/{{$dealer->id}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="{{__('dealers\list.view')}}">
