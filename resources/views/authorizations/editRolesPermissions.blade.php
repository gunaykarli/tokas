            ...
            <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
                <div class="m-login__container">
                    ...
                    <div class="m-log__signup">
                        <!--begin::Form-->
                        <form method="post" action="/authorizeuser/store" class="m-form m-form--fit m-form--label-align-right">
                            @csrf
                                            ...
                                            <div class="m-portlet__head-caption">
                                                <div class="m-portlet__head-title" >
                                                        ...
                                                        <select class="form-group m-form__group" name="employeeID" >
                                                            <option > {{__('authorizations\authorizeUser.selectEmployee')}}</option>
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($rolesAuthorizations as $rolesAuthorization)
                                                                <tr>
                                                                    <td>{{__('authorizations\authorizeUser.'.$rolesAuthorization->systemFeature->lang_key_for_feature)}}</td>
                                                                    <td>
