            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <!--begin::Form-->
                        <form method="POST" action="/law-text/update/{{$lawText->id}}" class="m-form m-form--fit m-form--label-align-right">
                            {{csrf_field()}}
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <input class="form-control m-input" type="text" name="lawTextCode" value="{{$lawText->code}}" id="code">
                                </div>

                                <div class="form-group m-form__group">
                                    <label for="content"> {{__('lawTexts/create.content')}}</label>
                                    <textarea class="form-control m-input" name="lawTextContent"  id="content" rows="3">{{$lawText->content}}</textarea>
                                </div>
                            </div>
