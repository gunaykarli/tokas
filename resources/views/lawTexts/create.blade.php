                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <form method="POST" action="/law-text/store" class="m-form m-form--fit m-form--label-align-right">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group">
                                    <label for="content"> {{__('lawTexts/create.content')}}</label>
                                    <textarea class="form-control m-input" name="lawTextContent" id="content" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="m-portlet__foot m-portlet__foot--fit">
                                <div class="m-form__actions">
                                    <button type="submit" class="btn btn-primary">{{__('lawTexts/create.save')}}</button>
                                </div>
                            </div>
                        </form>
