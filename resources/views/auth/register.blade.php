            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right">{{ __('auth/register.mobile') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="officeID" class="col-md-4 col-form-label text-md-right">{{ __('auth/register.office') }}</label>

                            <div class="col-md-6">
                                @if (auth()->check())
                                    <select id="officeID" class="form-control{{ $errors->has('officeID') ? ' is-invalid' : '' }}" name="officeID" >
                                        @foreach(\App\Office::where('dealer_id', auth()->user()->dealer_id)->orderBy('name')->get() as $office)
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('auth/register.confirmPassword') }}</label>
