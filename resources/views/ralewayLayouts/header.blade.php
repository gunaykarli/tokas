...
<header>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown dropdown-main">
                                    ...
                                    <ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn"><!-- Control Animations by changing "fadeIn" to another property from animate.css, check animations page in features / ALSO dropdown-animation class controls the duration, ajust if need -->
                                        ...
                                        <li><a href="/dealer/index">{{__('partials\header.dealerManagement')}}</a></li>
    ...
    <!-- End Navigation Role-1 -->
    @elseif(auth()->user()->role_id == 4)
    <!-- Begin Navigation Role-4 -->
    <div class="navbar-wrapper">
        <div class="navbar navbar-main" id="fixed-navbar">
            <div class="container">
                <div class="row">
                        ...
                        <nav class="navbar-collapse collapse navHeaderCollapse" role="navigation">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown dropdown-main">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{__('partials\header.infoCenter')}}<span class="fa fa-angle-down dropdown-arrow"></span></a>
                                    <ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn"><!-- Control Animations by changing "fadeIn" to another property from animate.css, check animations page in features / ALSO dropdown-animation class controls the duration, ajust if need -->
                                        <li><a href="features-typography.html">{{__('partials\header.imprint')}}</a></li>
                                        <li><a href="features-typography.html">{{__('partials\header.downloads')}}</a></li>
                                        <li><a href="features-typography.html">{{__('partials\header.FAQ')}}</a></li>
                                        <li><a href="features-typography.html">{{__('partials\header.newsletter')}}</a></li>
                                        <li><a href="features-typography.html">{{__('partials\header.termsAndConditions')}}</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown dropdown-main">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{__('partials\header.account')}}<span class="fa fa-angle-down dropdown-arrow"></span></a>
                                    <ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn"><!-- Control Animations by changing "fadeIn" to another property from animate.css, check animations page in features / ALSO dropdown-animation class controls the duration, ajust if need -->
                                        <li><a href="/dealer/view/{{auth()->user()->dealer_id}}">{{__('partials\header.companyInfo')}}</a></li>
                                        <li><a href="/office/list/{{auth()->user()->dealer_id}}">{{__('partials\header.offices')}}</a></li>
                                        <li><a href="/employee/dealer/list/{{auth()->user()->dealer_id}}">{{__('partials\header.employees')}}</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown hidden-sm hidden-xs">
                                    <a href="#" class="ml10 nav-circle-li dropdown-toggle dropdown-form-toggle" data-toggle="dropdown"><i class="fa fa-shopping-cart"></i></a>
