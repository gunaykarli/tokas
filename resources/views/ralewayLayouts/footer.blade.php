    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3 hidden-xs">
                ...
                <div class="col-xs-4 recent-work-padding">
                    <a href="{{ asset('raleway/images/projects/web3.jpg')}}" class="thumbnail image-zoom-link">
                        <img src="{{ asset('raleway/images/projects/thumbs/web3.jpg')}}" alt="..." class="thumbnail img-responsive">
                    </a>
                </div>
                <div class="col-xs-4 recent-work-padding">
                    <a href="{{ asset('raleway/images/projects/illustration1.jpg')}}" class="thumbnail image-zoom-link">
                        <img src="{{ asset('raleway/images/projects/thumbs/illustration1.jpg')}}" alt="..." class="thumbnail img-responsive">
                    </a>
                </div>
            </div>
        </div><!-- /row -->
