            ...
            <div class="m-portlet m-portlet--full-height">
                ...
                <div class="m-wizard m-wizard--2 m-wizard--success" id="m_wizard">
                    ...
                    <div class="m-wizard__form">
                        ...
                        <!--begin: Form -->
                        <form method="POST" action="/provider/update/{{$provider->id}}" class="m-form m-form--label-align-left- m-form--state-" id="m_form">
                        ...
                        {{csrf_field()}}
                            ...
                            <div class="m-portlet__body">
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">Provider Details</h3>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* Name:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="name" class="form-control m-input" placeholder="" value={{$provider->name}}>
                                                        <span class="m-form__help">Please enter name of provider</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="streetAddress" class="form-control m-input" placeholder="" value={{$provider->addresses->first()->street_address}}>
                                                        <span class="m-form__help">Street address, c/o</span>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">P.O. box:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="POBox" class="form-control m-input" placeholder="" value={{$provider->addresses->first()->PO_box}}>
                                                        <span class="m-form__help">P.O. box</span>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Postal Code:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="postalCode" class="form-control m-input" placeholder="" value={{$provider->addresses->first()->postal_code}}>
                                                        <span class="m-form__help">Postal Code</span>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* City:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="city" class="form-control m-input" placeholder="" value={{$provider->addresses->first()->city}}>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* State:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="state" class="form-control m-input" placeholder="" value={{$provider->addresses->first()->state}}>
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                ...
                                <!--begin: Form Wizard Step 3 Confirmation-->
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            ...
                                            <ul class="nav nav-tabs m-tabs-line--2x m-tabs-line m-tabs-line--danger" role="tablist">
                                                <li class="nav-item m-tabs__item">
                                                    <a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_form_confirm_1" role="tab">1. Provider Information</a>
                                                </li>
                                                <li class="nav-item m-tabs__item">
                                                    <a class="nav-link m-tabs__link" data-toggle="tab" href="#m_form_confirm_2" role="tab">2. Mailing Address</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content m--margin-top-40">
                                                <div class="tab-pane active" id="m_form_confirm_1" role="tabpanel">
                                                    <div class="m-form__section m-form__section--first">
                                                        <div class="m-form__heading">
                                                            <h4 class="m-form__heading-title">Provider Details</h4>
                                                        </div>
...
@section('pageVendorsAndScripts')
    ...
    <script src="{{ asset('metronic/assets/demo/default/custom/crud/wizard/createProviderwizard3.js')}}" type="text/javascript"></script>
    <!--end::Page Scripts -->
@endsection