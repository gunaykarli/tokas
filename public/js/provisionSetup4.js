$(document).ready(function(){
    // enterance for all tariffs
    $('#forAllTariffs-Div').hide();

    $('#forAllTariffs').change(function () {
        if(this.checked === true){
            $('#forAllTariffs-Div').show();
        }
        else{
            $('#forAllTariffs-Div').hide();
        }
    ...
    $('#radioInLineGroups').change(function(){
        ...
        var _token = $('input[name="_token"]').val();
        $.ajax({
            url:"/tariff/vodafone/fetch-provision-of-tariffs-by-group",
            method:"Post",
