...
//Private properties
     ...
     *                                                                              *
     *******************************************************************************/
    function __construct($orientation='P', $unit='mm', $format='A4') //function FPDF($orientation='P',$unit='mm',$format='A4')
    {
        //Some checks
        $this->_dochecks();
    ...
    function Header()
    {
        if($GLOBALS["festport"] != "ja"){
            if($GLOBALS["datenschutz"] == "ja"){
                //$this->SetLineWidth(0.3);
                //$this->Line(10,17,205,17);
                //$this->Line(10,290,205,290);
                //$this->SetFont('Arial','',10);
                //$this->Text(171,295,'Seite '.$this->PageNo());
            }else{
                $datum = getdate();
                $datum[mon] = sprintf("%02.0f", $datum[mon]);
                $datum[mday] = sprintf("%02.0f", $datum[mday]);
                $Date = "$datum[mday].$datum[mon].$datum[year]";
                $this->SetFont('Arial','',10);
                $this->Image('Images/vf_logo.png',146,4);
                $this->SetLineWidth(0.3);
                $this->Line(10,17,205,17);
                $this->Line(10,290,205,290);
                $this->Text(187,21,$Date);
                $this->Text(10,295,'Ausgedruckt mit TOKAS                                                                                                                             Seite '.$this->PageNo());
            }
        }else{
            $this->SetLineWidth(0.3);
            $this->Line(10,17,205,17);
